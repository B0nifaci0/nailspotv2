    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4">
                ...
                <h5 class="text-lg mt-0 mb-2 text-gray-700">Tenemos la opción correcta para ti, escribenos a través de
            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="flex flex-wrap items-top mb-6">
                    <div class="w-full lg:w-4/12 px-4 ml-auto">
                        <span class="block uppercase text-gray-600 text-sm font-semibold mb-2">Enlaces Utiles</span>
