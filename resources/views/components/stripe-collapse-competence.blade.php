<form id="payment-form">
    ...
    <button type="submit" id="submit-button"
        class="block w-full px-4 py-2 mt-4 font-bold text-center text-white bg-pink-500 hover:bg-pink-600 rounded-xl">Pagar
        en OXXO</button>
</form>
            ...
            .then(function(responseJson) {
                ...
                stripe.confirmOxxoPayment(
                    ...
                    .then(function(result) {
                        ...
                        window.location.replace('{{route('profile.competences') }}');
                    });
                })
    });
</script>