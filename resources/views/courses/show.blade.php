<x-app-layout>
            ...
            <div class="sm:w-2/2 md:w-2/3 lg:w-2/4 xl:w-3/5 ">
                <section class="mt-5 mb-5 ml-4 mr-4 bg-indigo-800">
                    <div class="flex flex-col flex-1 p-4 overflow-hidden">
                        <h1 class="mb-2 text-5xl text-center text-white justify-items-center">{{ $course->name }}</h1>
                        <h2 class="mb-3 ml-5 text-xl text-white break-words">{!! $course->description !!}</h2>
    ...
    <div class="bg-purple-800">
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div class="order-2 lg:col-span-2 ">
                <section class="mt-5 mb-5 ml-4 mr-4 bg-indigo-800">
                    <div class="card-body roundedxl">
                        <h1 class="mb-3 text-3xl font-bold text-center text-white">Lo que aprenderas en este curso...
                        </h1>
            ...
            <div class="order-2">
                <section class="mt-5 mb-5 ml-4 mr-4 bg-indigo-800 overflow-hidden">
                    <div class="card-body">
                        <h1 class="text-3xl font-bold text-center text-white">Descripción</h1>
                        <div class="text-base text-white break-words">
                            {!! $course->description !!}
                        </div>
                    </div>
                </section>
            ...
            <div class="order-2 lg:col-span-1 ">
                <section class="mt-5 mb-5 ml-4 mr-4 bg-indigo-800 ">
                    <div class="card-body">
                        ...
                        @can('enrolled', $course)
                            <a href="{{ route('course.status', $course) }}" type="submit"
                                class="block w-full px-4 py-2 mt-4 font-bold text-center text-white bg-pink-500 hover:bg-pink-600 rounded-xl">Continuar
                                con
                                el
                                curso</a>
                        @else
                                ...
                                <div class="ml-2">
                                    ...
                                    @if ($similar->rating != 6)
                                        <p class="text-sm text-white"><i
                                                class="mr-2 text-yellow-400 fas fa-star"></i>{{ $similar->rating }}
                                        </p>
                                    @endif
                                </div>
                            </article>
