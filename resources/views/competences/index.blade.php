<x-app-layout>
    ...
    <div class="sliderAx  bg-purple-800">
        ...
        <div id="slider-2" class=" mx-auto">
            <div class="bg-cover bg-center  text-white py-72 px-10 object-fill" style='background-image: 
    ...
    <div class="bg-purple-800 mx-auto">
        <h2 class="text-5xl text-white text-center ">Competencias</h2>
    </div>
    @endsection
