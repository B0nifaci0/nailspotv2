<x-app-layout>
    ...
    <div class="mt-10 p-10">
        ...
        <div class=" w-full lg:max-w-full lg:flex">
            <div class="h-48 lg:h-96 lg:w-1/2 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
                style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Mountain">
            </div>
            <div
