            ...
            <div class="mx-auto max-w-7xl">
                <nav class="flex items-center w-full h-24" x-data="{ showMenu: false }">
                    <div
                        ...
                        <a href="#_" class="w-1/4 py-4 pl-6 pr-4 md:pl-4 md:py-0">
                            <span class="text-xl font-black leading-none text-white select-none logo">tails<span
                        ...
                        <div class="fixed top-0 left-0 z-40 items-center hidden w-full h-full p-3 text-xl bg-gray-900 bg-opacity-50 md:text-sm lg:text-base md:w-3/4 md:bg-transparent md:p-0 md:relative md:flex"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        class="inline-block px-0 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Features</a>
                                    <a href="#"
                                        class="inline-block px-0 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Blog</a>
                                    <a href="#"
                                        class="inline-block px-0 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center">Contact</a>
                                </div>
                                <div
                                    class="flex flex-col items-center justify-end w-full h-full pt-4 md:w-1/3 md:flex-row md:py-0">
                                    <a href="#_"
                                        class="inline-flex justify-center w-full mb-1 mr-0 text-indigo-200 hover:text-white md:pl-0 md:mr-3 lg:mr-5 md:w-auto md:mb-0">Sign
                                        In</a>
                                    <a href="#_"
                        ...
                        <div @click="showMenu = !showMenu"
                            class="absolute right-0 z-50 flex flex-col items-end w-10 h-10 p-2 mr-4 rounded-full cursor-pointer md:hidden"
                            :class="{ 'text-indigo-700 hover:bg-gray-200': showMenu, 'hover:bg-indigo-700 text-indigo-200': !showMenu }">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div class="py-8 px-4 bg-white  rounded-b-md fd-cl group-hover:opacity-25">
                                ...
                                <span class="block text-gray-600 text-sm">Vivamus ac ligula sit amet erat luctus laoreet
                                    ac quis ligula.
                                    Donec bibendum faucibus purus eget cursus. Proin enim ante, scelerisque vel sem sit
                                    amet, ultrices
                                    mollis risus. Praesent justo felis, ullamcorper a cursus sed, condimentum at dui.
                                </span>
                            </div>
                        </div>
                        <div class="absolute opacity-0 fd-sh group-hover:opacity-100">
                            <span class="text-3xl font-bold text-white tracking-wider leading-relaxed font-sans">Paris
                                city of
                                light</span>
                            <div class="pt-8 text-center">
                                <button
                                    class="text-center rounded-lg p-4 bg-white  text-gray-700 font-bold text-lg">Learn
                                    more</button>
                            </div>
                        </div>
                    </div>
                ...
                {{-- <div class="container py-32 mx-auto text-center sm:px-4">
                    ...
                    <div
                        ...
                        If you are ready to change the way you design websites, then <br>use our block builder to make
                        it fun and easy!</div>
                    <div class="relative flex items-center max-w-md mx-auto mt-12 text-center">
                        <input type="text" name="email" placeholder="Email Address"
                            class="w-full h-12 px-6 py-2 font-medium text-indigo-800 rounded-l-full focus:outline-none">
                        <span class="relative top-0 right-0 block rounded-full shadow-sm">
                            <button type="button"
                                class="inline-flex items-center w-32 h-12 px-8 text-base font-bold leading-6 text-white transition duration-150 ease-in-out bg-indigo-400 border border-transparent rounded-r-full hover:bg-indigo-700 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">
                                Sign Up
                            </button>
                        </span>
                    </div>
