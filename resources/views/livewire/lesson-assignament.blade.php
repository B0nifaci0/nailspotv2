<div class="card">
    ...
    <form wire:submit.prevent='save'>
        <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
            <div class="md:flex">
                <div class="w-full">
                    <div class="p-4 border-b-2"> <span class="text-lg font-bold text-gray-700 ">Agregar tarea</span>
                    </div>
                    <div class="p-3">
                        ...
                        <div class="mb-2"> <span>Tarea</span>
                            <div class="rounded-lg border-2 border-gray-200 flex justify-center items-center ">
                                <label
                                    class=" w-full flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-pink-300 hover:text-white">
                                    <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20">
                                        <path
                                            d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                                    </svg>
                                    <span class="mt-2 text-base leading-normal">Selecionar un archivo</span>
                        ...
                        <div class="mt-3 text-center pb-3">
                            <button
                                class="w-full h-12 text-lg bg-pink-600 rounded text-white hover:bg-pink-700">Subir</button>
                        </div>
                    </div>
                </div>
            </div>
