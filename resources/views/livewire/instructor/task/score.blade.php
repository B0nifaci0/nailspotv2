<div class="grid grid-cols-2 gap-4">
    ...
    <button wire:click='qualify'
        class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">Calificar</button>
    @endif
</div>
