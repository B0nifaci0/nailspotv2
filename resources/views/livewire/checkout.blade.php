    ...
    <div class="flex flex-col w-full mx-auto sm:w-1/2 md:w-2/3">
        <section class="bg-indigo-800 rounded-xl">
            <div class="flex flex-col flex-1 p-4" style="">
                ...
                <br>
                <div class="grid sm:grid-cols-1 md:grid-cols-4 overflow-hidden">
                    <div class="">
                        <img src="{{ $course->image->url }}" class="rounded md:rounded-full sm:h-20 sm:h-full" alt="Thumbnail">
                    </div>
                    <div class="">
                        <p class=" mb-2 text-3xl text-white md:m-4">{{ $course->name }}</p>
                    </div>
                    <div class="break-words pt-2 text-xl font-medium text-white md:col-span-2">
                        {!! $course->description !!}
                    </div>
                </div>
            </div>
