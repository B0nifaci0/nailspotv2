...
@section('title', 'Editar Subcompetencia')
...
@section('content')
    <div class="py-8 bg-purple-800">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($subcompetence, ['method' => 'PUT', 'route' => ['admin.subcompetences.update', [$competence, $category, $subcompetence]], 'class' => 'form-horizontal']) !!}
